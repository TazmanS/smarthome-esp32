...
const ledc_channel_t FAN_MOTOR_INA_CHANNEL = LEDC_CHANNEL_1; /** LEDC channel for fan motor INA control */
const ledc_channel_t FAN_MOTOR_INB_CHANNEL = LEDC_CHANNEL_2; /** LEDC channel for fan motor INB control */