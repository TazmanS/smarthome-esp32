...
const gpio_num_t PHOTOCELL_PIN = GPIO_NUM_39; /**< Analog pin for photocell sensor */
...
const gpio_num_t FAN_MOTOR_INA_PIN = GPIO_NUM_17; /**< Fan motor INA GPIO */
const gpio_num_t FAN_MOTOR_INB_PIN = GPIO_NUM_16; /**< Fan motor INB GPIO */

const gpio_num_t IR_RECEIVER_PIN = GPIO_NUM_5; /**< IR receiver GPIO */
